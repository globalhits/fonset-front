    ...
    return (
        <>
            <div className="row">
                ...
                <div className="col-lg-4 ">
                    <InputSelected label="Departamento*" options={departaments} onChange={(value: any) => changeDepartament(value)} value={data.PROY_DEPARTAMENTO} />
                </div>
                <div className="col-lg-4">
                    <InputSelected label="Municipios*" className="mb-3 inputFloating" options={filters} onChange={(value: any) => setValueByIndex("PROY_MUNICIPIO_ORIGEN", value)} value={data.PROY_MUNICIPIO_ORIGEN} disabled={disabledMunicipalities} />
                </div>
            </div>
            <div className="row">
                <div className="col-lg-4 ">
                ...
                <div className="col-lg-4 ">
                    <InputSelected label="Distrito judicial*" className="mb-3 inputFloating" options={districts} onChange={(value: any) => setValueByIndex("PROY_DISTRITO_JUDICIAL", value)} value={data.PROY_DISTRITO_JUDICIAL} />
                </div>
            </div>
        </>
    )
