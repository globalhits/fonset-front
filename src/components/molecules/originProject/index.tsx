...
const OriginProject: React.FC<any> = ({ }) => {
    ...
    return (
        <>
            ...
            <Row>
                <Col sm={3}>
                    <InputFloating label="Cod. proyecto*" className="mb-3 inputFloating" type="text" setValueChange={(value: any) => setValueByIndex("PROY_CODIGO", value)} value={data.PROY_CODIGO} readOnly={true} isInvalid={!data.PROY_CODIGO && errorInputs} />
                </Col>
                <Col sm={3}>
